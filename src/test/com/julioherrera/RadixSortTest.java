...
import com.julioherrera.RadixSort;
...
/** 
* 
* Method: radix(int[] array, int n, int exp) 
* 
*/ 
@Test
public void testSort() throws Exception {

    int[] numbersDeso = {8,-5,1,6,-9,15,354,74,212,108,-86,-21};
    RadixSort radixSort = new RadixSort();
    int[] numbersOrd = new int[12];
    numbersOrd = radixSort.sort(numbersDeso);
    int[] numbersOrdEsp = {-86,-21,-9,-5,1,6,8,15,74,108,212,354};
